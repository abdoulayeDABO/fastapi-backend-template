...
def generate_confirm_signup_email(
    ...
    html_content = render_email_template(
        template_name="confirm_signup.html",
        context={
...
def generate_new_account_email(username: str, password: str) -> EmailData:
    project_name = settings.PROJECT_NAME
    subject = f"{project_name} - Account activation email for user {username}"
    html_content = render_email_template(
        template_name="new_account.html",
        context={"user_name": username, "password": password},
    )
    return EmailData(html_content=html_content, subject=subject)
